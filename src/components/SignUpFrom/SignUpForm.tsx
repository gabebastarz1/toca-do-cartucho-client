...
const SignUpForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { email, senha, nome, sobrenome, nomeUsuario, cpf } = formData;
  ...
  return (
    <div className="mx-auto my-10 p-8 md:bg-[#E8E6F1] md:p-10 md:shadow-lg rounded-lg text-white md:text-[#2B2560] w-full max-w-md">
      <CustomAlert
